...
\begin{table}[ht]
\centering
\caption{\textbf{Master 3D Volumetric Brain Glioma Segmentation Benchmark} (BraTS 2024 GLI held-out test split, $N=271$ volumes) evaluated following 5-epoch training under AMP. Effective Spectral Rank ($\text{erank}$) is evaluated on the $128$-dimensional pre-training projector representation ($D_{\text{proj}} = 128$). Best per column is in \textbf{bold}.}
